...
public class TamirDao {
    ...
    public void update(Tamir tamir, Long selectedParca) {
        try {
            ...
            PreparedStatement pst = this.getConnection().prepareStatement("update tamir set ucret=? where tamir_id=?");
            pst.setInt(1, tamir.getTbi_ucret());
            pst.setLong(2, tamir.getTamir_id());
    ...
    public void delete(Tamir tamir) {
        ...
        try {
            ...
            PreparedStatement pst = this.getConnection().prepareStatement("delete from tamir where tamir_id =?");
            pst.setLong(1, tamir.getTamir_id());
            pst.executeUpdate();
